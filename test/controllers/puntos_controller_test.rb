...
class PuntosControllerTest < ActionController::TestCase
  ...
  test "should update punto" do
    patch :update, id: @punto, punto: { angulo: @punto.angulo, distancia: @punto.distancia, latitud: @punto.latitud, longitud: @punto.longitud, proyecto_id: @punto.proyecto_id, punto: @punto.punto, secuencia: @punto.secuencia }
    assert_redirected_to punto_path(assigns(:punto))
  end
