...
class CondclimasControllerTest < ActionController::TestCase
  ...
  test "should update condclima" do
    patch :update, id: @condclima, condclima: { hielo: @condclima.hielo, nombre: @condclima.nombre, temp: @condclima.temp, viento: @condclima.viento, zona_id: @condclima.zona_id }
    assert_redirected_to condclima_path(assigns(:condclima))
  end
