...
class ProyectosControllerTest < ActionController::TestCase
  ...
  test "should update proyecto" do
    patch :update, id: @proyecto, proyecto: { comitente: @proyecto.comitente, cond_e_id: @proyecto.cond_e_id, cond_g_id: @proyecto.cond_g_id, constructor: @proyecto.constructor, desc: @proyecto.desc, dretmax: @proyecto.dretmax, expediente: @proyecto.expediente, fproyecto: @proyecto.fproyecto, hlibre: @proyecto.hlibre, proyectista: @proyecto.proyectista, proyecto: @proyecto.proyecto, tconstr_id: @proyecto.tconstr_id, ubicacion: @proyecto.ubicacion, vanomax: @proyecto.vanomax, zona_id: @proyecto.zona_id }
    assert_redirected_to proyecto_path(assigns(:proyecto))
  end
