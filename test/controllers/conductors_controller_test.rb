...
class ConductorsControllerTest < ActionController::TestCase
  ...
  test "should update conductor" do
    patch :update, id: @conductor, conductor: { coef_e: @conductor.coef_e, coef_t: @conductor.coef_t, diametro: @conductor.diametro, imax: @conductor.imax, nombre: @conductor.nombre, peso: @conductor.peso, relec: @conductor.relec, rmec: @conductor.rmec, seccion: @conductor.seccion, tmax: @conductor.tmax, tmed: @conductor.tmed }
    assert_redirected_to conductor_path(assigns(:conductor))
  end
